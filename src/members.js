...
export default{
	...
	members:[
		new Person("Kevin", [
			...
			new Task(new Date('24 june 2018 21:00'),"Finish the theory-part of the paper", false, 3, 1),
		...
		new Person("Denny", [
			...
			new ReviewTask(new Date('8 june 2018 21:00'), "Review \'Write code for login-form\' by Kevin")
			]),
		new Person("Tommy", [
