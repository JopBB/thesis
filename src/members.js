...
export default{
	members:[
		new Person("Tommy", [
			...
			new ReviewTask(new Date('8 may 2018 23:00'), "Review \'Write Related Work section 3 and 4\' by Denny", true)
			]),
		new Person("Lisa", [
			...
			new ReviewTask(new Date('8 may 2018 23:00'), "Review \'Start writing results\' by Denny", false)
			]),
		new Person("Denny", [
			...
			new Task(new Date('19 may 2018 23:00'),"Start writing results", false, true),
			new Task(new Date('19 may 2018 23:00'),"Finish up results and analysis", false, false),
			new Task(new Date('4 june 2018 23:00'),"Finish the paper", false, false)
			],[
			new ReviewTask(new Date('8 may 2018 23:00'), "Review \'Write code for login-form\' by Tommy", false)
			])
	]	
}